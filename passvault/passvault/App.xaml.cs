...
namespace passvault
{
    ...
    {
        public myDict globalDictionary = new myDict();
        public bool isLoggedIn = false;
        public string FilePath = "pinFile";
        public string userSettingPath = "userSetting";
        public bool userCreated = false;
        public masteruser m = new masteruser();
        ...
        {
            globalDictionary.protect(FilePath);
        }
        ...
        private void WritePinToFile(byte[] pinData, String SettingPath)
        {
        ...
        private byte[] ReadPinFromFile(string SettingPath)
        {
            // Access the file in the application's isolated storage.
            IsolatedStorageFile file = IsolatedStorageFile.GetUserStoreForApplication();
            if(file.FileExists(SettingPath))
            {
